...
const SCENARIOS: SimulationScenario[] = [
  {
    ...
    nodes: [
      ...
      { id: 'n8', type: 'action', label: '排料速度控制', x: 80, y: 70, description: '控制炉底排料装置的速度以调节物料在炉内的停留时间。', skills: ['物料停留时间分布(RTD)', '排料螺旋控制'] },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'n1', type: 'planning', label: '熔炼制度', x: 50, y: 15, description: '制定合理的供电曲线和造渣制度。', skills: ['全流程物料平衡计算'] },
      { id: 'n2', type: 'flow', label: '加料', x: 20, y: 50, description: '将金属化球团加入电炉。', skills: ['钒钛矿高温软熔特性计算'] },
      { id: 'n3', type: 'action', label: '通电升温', x: 40, y: 50, description: '电极供电产生电弧热，熔化炉料。', skills: ['电炉熔池搅拌控制'] },
      { id: 'n4', type: 'data', label: '熔池温度', x: 40, y: 80, description: '监控熔池内的铁水和渣层温度。', skills: ['温度场软测量'] },
      { id: 'n5', type: 'flow', label: '渣铁分离', x: 60, y: 50, description: '利用密度差实现渣铁分离。', skills: ['钒钛磁铁矿物相解构'] },
      { id: 'n6', type: 'data', label: '渣中V含量', x: 60, y: 20, description: '检测炉渣中的氧化钒含量，评估回收率。', skills: ['产品质量软测量'] },
      { id: 'n7', type: 'action', label: '出铁/出渣', x: 80, y: 50, description: '定期排出铁水和炉渣。', skills: ['电炉安全操作规程'] },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'n1', type: 'planning', label: '浸出率目标', x: 50, y: 10, description: '设定钒的浸出率目标。', skills: ['多目标优化算法'] },
      { id: 'n2', type: 'flow', label: '焙烧', x: 20, y: 50, description: '将钒渣进行钠化或钙化焙烧，使钒转化为可溶性盐。', skills: ['反应动力学推演'] },
      { id: 'n3', type: 'flow', label: '水浸', x: 40, y: 50, description: '用水或稀酸浸出焙烧熟料。', skills: ['浸出反应动力学'] },
      { id: 'n4', type: 'data', label: 'pH值', x: 40, y: 20, description: '监控浸出液的酸碱度。', skills: ['PID控制回路'] },
      { id: 'n5', type: 'action', label: '加酸调节', x: 40, y: 80, description: '调节溶液pH值以优化浸出环境。', skills: ['流量自适应控制'] },
      { id: 'n6', type: 'flow', label: '沉钒', x: 60, y: 50, description: '加入铵盐使钒沉淀析出。', skills: ['沉钒结晶控制'] },
      { id: 'n7', type: 'data', label: 'V2O5纯度', x: 80, y: 50, description: '检测最终产品五氧化二钒的纯度。', skills: ['产品质量软测量'] },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'n1', type: 'data', label: '尾矿成分', x: 20, y: 50, description: '分析尾矿中的有用组分和有害元素。', skills: ['钒钛磁铁矿物相解构'] },
      { id: 'n2', type: 'planning', label: '环保标准', x: 50, y: 10, description: '设定处理后的排放标准。', skills: ['环保排放标准核查'] },
      { id: 'n3', type: 'flow', label: '磁选回收', x: 40, y: 50, description: '回收尾矿中的残余铁精矿。', skills: ['磁选效率计算'] },
      { id: 'n4', type: 'action', label: '调节磁场强度', x: 40, y: 80, description: '优化磁选机参数。', skills: ['PID控制回路'] },
      { id: 'n5', type: 'flow', label: '压滤脱水', x: 60, y: 50, description: '降低尾矿含水率，便于干堆。', skills: ['压滤机工况监控'] },
      { id: 'n6', type: 'data', label: '含水率', x: 60, y: 20, description: '监控脱水后的尾矿含水率。', skills: ['产品质量软测量'] },
      { id: 'n7', type: 'flow', label: '干堆/回填', x: 80, y: 50, description: '尾矿的最终处置。', skills: ['尾矿库安全监测'] },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n3' },
  ...
  },
  {
    ...
    nodes: [
      { id: 'n1', type: 'data', label: '实时电耗', x: 20, y: 30, description: '监控各工序的电力消耗。', skills: ['历史数据回归分析'] },
      { id: 'n2', type: 'data', label: '天然气流量', x: 20, y: 70, description: '监控天然气消耗量。', skills: ['气体组分实时分析'] },
      { id: 'n3', type: 'planning', label: '能耗基准', x: 50, y: 10, description: '设定能耗基准线。', skills: ['生产成本估算模型'] },
      { id: 'n4', type: 'flow', label: '能效分析模型', x: 50, y: 50, description: '分析能耗数据，寻找节能潜力。', skills: ['多目标优化算法'] },
      { id: 'n5', type: 'action', label: '负荷调度', x: 80, y: 30, description: '优化生产负荷分配，避峰就谷。', skills: ['多目标优化算法'] },
      { id: 'n6', type: 'action', label: '余热回收', x: 80, y: 70, description: '回收高温烟气和炉渣的显热。', skills: ['换热效率计算'] },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n4' },
